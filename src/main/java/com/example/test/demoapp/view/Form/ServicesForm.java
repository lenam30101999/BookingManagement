...
public class ServicesForm extends javax.swing.JFrame {
    ...
    Statement st= null;
        ...
        try {
            listServices = (ArrayList<Services>) connection.listServices();
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public void hienThiDanhSachDichVu() {
        ...
        ArrayList<Services> dsdv = layDanhSachDichVu();
    ...
    private void them2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_them2ActionPerformed
        ...
        try {
            ...
            connection.addServices(services);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void xoa2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_xoa2ActionPerformed
        ...
        try {
            // Tạo một đối tượng để thực hiện công việc
            connection.deleteServices(jTextFieldMADV.getText());
        } catch (Exception ex) {
