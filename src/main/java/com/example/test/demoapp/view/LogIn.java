...
public class LogIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\BVCN 88\\Desktop\\hinh\\if_preferences-desktop-cryptography_8794.png")); // NOI18N
        jLabel1.setText("Tài Khoản");

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\BVCN 88\\Desktop\\hinh\\ssssss.png")); // NOI18N
        jLabel2.setText("Pass");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 26)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\BVCN 88\\Desktop\\hinh\\if_6_2247708.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        }else if(controller.connect().findPassword(jTextFieldUsername.getText().trim()).equals(
                    jPasswordField1.getText().trim()) == true){
                MenuForm menuForm = new MenuForm();
                menuForm.setVisible(true);
                this.dispose();
        }else{
                JOptionPane.showConfirmDialog(this, "Tài khoản không tồn tại");
        }
        System.out.println(jPasswordField1.getText()+" "+jTextFieldUsername.getText());
